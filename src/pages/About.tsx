        ...
        <div className="font-sans text-gray-900 dark:text-white bg-[#F7F8F8] dark:bg-slate-950 transition-colors duration-500 overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-16 lg:pb-24">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 relative z-20 flex flex-col items-center text-center">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] md:w-[600px] aspect-square rounded-full border-[1.5px] border-blue-500/15 dark:border-blue-400/15 bg-gradient-to-b from-blue-500/5 to-transparent dark:from-blue-600/5 pointer-events-none z-0 blur-[1px] animate-breathing" style={{ animationDuration: '4s', animationDelay: '1s' }}></div>
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[400px] aspect-square rounded-full border-2 border-blue-500/20 dark:border-blue-400/20 bg-gradient-to-b from-blue-500/10 to-transparent dark:from-blue-600/10 pointer-events-none z-0 shadow-[0_0_80px_rgba(59,130,246,0.15)] dark:shadow-[0_0_80px_rgba(59,130,246,0.25)] animate-breathing" style={{ animationDuration: '3s', animationDelay: '2s' }}></div>
