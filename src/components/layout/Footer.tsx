                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start">
                                <Icon name="location_on" className="text-[20px] mr-2 text-tabo-primary flex-shrink-0" />
                                <span>123 Đường Công Nghệ, Quận 1, TP. Hồ Chí Minh</span>
                            </li>
                            <li className="flex items-center">
                                <Icon name="phone" className="text-[20px] mr-2 text-tabo-primary flex-shrink-0" />
                                <span>+84 123 456 789</span>
                            </li>
                            <li className="flex items-center">
                                <Icon name="mail" className="text-[20px] mr-2 text-tabo-primary flex-shrink-0" />
