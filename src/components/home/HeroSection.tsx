...
const HeroSection: React.FC = () => {
    return (
        <section className="relative bg-[#F7F8F8] dark:bg-slate-950 pt-32 pb-16 lg:pt-[164px] lg:pb-24 overflow-hidden min-h-[85vh] lg:min-h-[80vh] flex items-center justify-center transition-colors duration-500">
            ...
            <div className="absolute top-[25%] right-[20%] opacity-30 text-blue-600 dark:text-blue-400 pointer-events-none animate-pulse" style={{ animationDuration: '3s' }}>
                <Icon name="star" className="text-[18px]" />
            </div>
            <div className="absolute bottom-[35%] left-[10%] opacity-30 text-cyan-600 dark:text-cyan-400 pointer-events-none -rotate-12 animate-bounce" style={{ animationDuration: '5s', animationDelay: '1s' }}>
