...
const PricingFeatures: React.FC = () => {
    ...
    const rowGridClass = activeTab === 'free'
        ? "grid gap-4 md:gap-8 px-6 lg:px-8 py-5 border-b border-slate-50 last:border-b-0 items-center hover:bg-slate-50/30 transition-colors grid-cols-1 md:grid-cols-[1fr_150px_150px] lg:grid-cols-[1fr_200px_200px]"
        : "grid gap-4 md:gap-8 px-6 lg:px-8 py-5 border-b border-slate-50 last:border-b-0 items-center hover:bg-slate-50/30 transition-colors grid-cols-1 md:grid-cols-[1fr_150px] lg:grid-cols-[1fr_200px]";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12 lg:mb-16">
                    ...
                    <div className="flex relative z-20 flex-shrink-0 lg:pb-1">
                        <div className="bg-slate-100 p-1 rounded-full inline-flex relative border border-slate-200/50">
                            <div
                            ...
                            <button
                                ...
                                className={`relative z-10 w-24 sm:w-32 py-2 text-[13px] sm:text-sm font-semibold rounded-full transition-colors ${
                                    activeTab === 'free' ? 'text-blue-600' : 'text-slate-500 hover:text-slate-900'
                                }`}
                            >
                                Miễn phí
                            </button>
                            <button
                                ...
                                className={`relative z-10 w-24 sm:w-32 py-2 text-[13px] sm:text-sm font-semibold rounded-full transition-colors ${
                                    activeTab === 'premium' ? 'text-blue-600' : 'text-slate-500 hover:text-slate-900'
                                }`}
                            >
                                Nâng cao
                            </button>
                ...
                <div className={headerGridClass}>
                    ...
                    {activeTab === 'free' ? (
                        <>
                            <div className="text-xs font-bold text-slate-400 text-center uppercase tracking-widest">Gói Miễn Phí</div>
                            <div className="text-xs font-bold text-slate-400 text-center uppercase tracking-widest">Mở Rộng</div>
                        </>
                    ) : (
                                            ...
                                            {activeTab === 'free' ? (
                                                <div className="md:hidden grid grid-cols-2 gap-4 pt-2">
                                                    <div className="flex flex-col gap-2">
                                                        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest text-left">Gói Miễn Phí</span>
                                                        <div className="flex justify-start">{renderValue(feat.free)}</div>
                                                    </div>
                                                    <div className="flex flex-col gap-2">
                                                        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest text-left">Mở Rộng</span>
                                                ...
                                                <div className="md:hidden grid grid-cols-1 gap-4 pt-2">
                                                    <div className="flex flex-col gap-2">
                                                        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest text-left">Gói Nâng Cao</span>
