# 📂 Tabo ERP Document Index (Registry)

Tài liệu này giúp AI nhanh chóng xác định các quy chuẩn và hướng dẫn cần thiết trước khi thực hiện task, giúp tiết kiệm quota và tăng độ chính xác.
...
---
> [!IMPORTANT]
> **Hướng dẫn cho AI:** Luôn quét file này đầu tiên khi nhận được yêu cầu mới để xác định context cần thiết.
